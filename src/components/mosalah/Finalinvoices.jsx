...
const Finalinvoices = ({ days = 7, hours = 0, minutes = 0, seconds = 0 }) => {
...
const navigate =useNavigate()
  ...
  <div className="col-md-12 col-lg-6 col-sm-12">
    <div className="form-group mb-2">
      <label htmlFor="freelancerName" style={{ fontSize: '1rem', fontWeight: 'bold' }}>Freelancer Name:</label>
      <input
        type="text"
        id="freelancerName"
    ...
    <div className="form-group mb-2">
      <label htmlFor="freelancerEmail" style={{ fontSize: '1rem', fontWeight: 'bold' }}>Email:</label>
      <input
        type="email"
        id="freelancerEmail"
    ...
    <div className="form-group mb-2">
      <label htmlFor="freelancerPhone" style={{ fontSize: '1rem', fontWeight: 'bold' }}>Phone Number:</label>
      <input
        type="tel"
        placeholder='Please Inter phone .. '

        id="freelancerPhone"
        className="form-control"
        value={invoice.freelancerPhone}
        style={{ backgroundColor: '#f0f8ff', width: '100%' }}
      />
    </div>
  </div>
