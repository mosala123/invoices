...
const RegisterCustomer = () => {
  ...
  const handleRegister = async (e) => {
    ...
    toast.success("تم إنشاء الحساب بنجاح! يمكنك الآن تسجيل الدخول.", { position: "top-right" });
    setTimeout(() => {
              ...
              <div className="row g-0">
                ...
                <div className="col-lg-6 p-4 p-lg-5 bg-white order-2 order-lg-1">
                  <div className="mb-4">
                    ...
                    <h2 className="fw-bold text-primary mb-2">انضم إلينا اليوم! ✨</h2>
                    <p className="text-muted">أنشئ حسابك كعميل وابدأ في إدارة أعمالك بذكاء.</p>
                  </div>
                  ...
                  <form onSubmit={handleRegister}>
                    ...
                    <div className="form-check mb-4">
                      ...
                      <label className="form-check-label small text-muted" htmlFor="terms">
                        أوافق على <a href="#" className="text-primary text-decoration-none">الشروط والأحكام</a> و <a href="#" className="text-primary text-decoration-none">سياسة الخصوصية</a>.
                      </label>
                    </div>
                    ...
                    <div className="text-center">
                      <p className="small text-muted mb-0">
                        لديك حساب بالفعل؟ <Link to="/loginclient" className="text-primary fw-bold text-decoration-none">سجل دخولك هنا</Link>
                      </p>
                    </div>
                  </form>
                </div>
                ...
                <div className="col-lg-6 bg-primary bg-opacity-10 d-none d-lg-flex align-items-center justify-content-center p-5 order-1 order-lg-2">
                  ...
                  >
                    <img src={imageregisterclient} alt="register" className="img-fluid mb-4" style={{ maxWidth: '80%' }} />
                    <h4 className="fw-bold text-primary">ابدأ رحلتك معنا اليوم</h4>
                    <p className="text-muted px-4">انضم إلى مجتمعنا المتنامي واستمتع بأفضل الأدوات لإدارة أعمالك المالية بكل سهولة.</p>
                  </motion.div>
                </div>
              </div>
            </div>
