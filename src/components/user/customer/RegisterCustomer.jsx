  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      const { error: insertError } = await supabase
        .from("clients")
        .upsert(
          { id: data.user.id, name: name.trim(), email: email.trim().toLowerCase(), role: "client" },
          { onConflict: "id" }
        );

      if (insertError) {
        console.error("Insert client error:", insertError.message);
        // لا نوقف التسجيل لأن الحساب تم إنشاؤه
      }
              ...
              <div className="d-none d-lg-flex" style={{ flex: 1, flexDirection: "column",
                ...
                <motion.div initial={{ x: -40, opacity: 0 }} animate={{ x: 0, opacity: 1 }}
                  ...
                  <div style={{ position:"relative",marginBottom:24 }}>
                    ...
                    <img src={imageregisterclient} alt="register"
                  ...
                  <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "0.86rem", lineHeight: 1.75 }}>
                    Join our growing community and manage your business finances with ease.
                  </p>
                  <div style={{ marginTop: 24, display:"flex", flexDirection:"column", gap: 10, textAlign:"left" }}>
                    {["Create professional invoices in seconds",
                      "Track payments & financial reports",
                      "Manage all your projects in one place"].map((f,i)=>(
              ...
              <div style={{ flex: 1, background: "#fff", padding: "36px 40px", overflowY: "auto" }}>
                ...
                <div style={{ marginBottom: 26 }}>
                  ...
                  <p style={{ color: "#888", fontSize: "0.88rem", marginBottom: 0 }}>
                    Sign up and start managing your projects smartly.
                  </p>
                </div>
                ...
                <form onSubmit={handleRegister}>
                  ...
                  <div style={{ display:"flex",alignItems:"flex-start",gap:10,marginBottom:22 }}>
                    <input type="checkbox" required style={{ accentColor:"#1a73e8",marginTop:2,flexShrink:0 }} />
                    <span style={{ fontSize:"0.82rem",color:"#777" }}>
                      I agree to the{" "}
                      <a href="#" style={{ color:"#1a73e8",textDecoration:"none",fontWeight:600 }}>Terms & Conditions</a>
                      {" "}and{" "}
                      <a href="#" style={{ color:"#1a73e8",textDecoration:"none",fontWeight:600 }}>Privacy Policy</a>
                    </span>
                  </div>
